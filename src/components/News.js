...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    setLoading(true);
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=9ac17ce3e6f34265ad596c8c776efda6&page=${page}&pageSize=${props.pageSize}`;
